...
# 1st case of this view function, it will render signup form when user request for it
# 2nd case: when user submit signup form.
def signup(request):
    ...
    #default case, simple rendering of signup form
    return render(request, "signup.html", {"form": SignUpForm})
...
# 2 cases: process login submission, and render login form
...
def concerts(request):
    if request.user.is_authenticated:
        lst_of_concert = [] #create an empty list
